...
export default function Header() {
  return (
    ...
    <nav className="w-full">
      <div className="container flex justify-between py-5 m-auto">
        <div className="brand">
          <span className="leading-3 font-semibold text-2xl">Discover</span>
        </div>
        <div className="search flex justify-between w-4/12">
          <div className="w-full">
            <input type="text" className="bg-transparent text-justify h-full w-full" placeholder="Seach anything"/>
          </div>
